...
public class CategoryTestCase {
	...
	{
		assertEquals("Successfully Fatched List Of categories from the table !", 2, categoryDAO.list().size());
	}*/
	...
	public void testCRUDCategory(){
		...
		//fetching the list
		assertEquals("Successfully Fatched List Of categories from the table !", 1, categoryDAO.list().size());
	}
